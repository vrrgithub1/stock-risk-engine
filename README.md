...
| Figure | Title | Image |
|---:|---|:---|
| 1 | Portfolio Correlation Matrix | ![Portfolio Correlation Matrix](docs/Portfolio_Correlation_Matrix.png) |
| 2 | Risk Analysis Dashboard | ![Risk Analysis Dashboard](docs/Risk_Analysis_Dashboard.png) |
| 3 | Risk Analysis with Panic Overlay | ![Risk Analysis with Panic Overlay](docs/Risk_Analysis_with_Panic_Overlay.png) |
